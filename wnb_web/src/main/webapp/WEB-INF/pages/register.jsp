...
<body>
<h1 align="center">欢迎来到学生管理系统注册中心</h1>
<form acton="${pageContext.request.contextPath}/register"method="post" >
  <table align="center">
    ...
    <tr>
      <td>性别：</td>
      <td><select name="sex" size="1"> <option value="man"> man</option> </select> <select name="sex" size="1">
        <option value="woman"> women</option> </select></td>
    </tr>
    <tr>
      <td>学历：</td>
